...
export default function RootLayout({
  ...
  return (
    <html lang="vi" suppressHydrationWarning>
      ...
      <body className={`${inter.className} ${spaceGrotesk.variable} antialiased flex flex-col min-h-screen relative`}>
        <ThemeProvider>
          {/* Lớp nền ảnh biển cả — ẩn trong light mode */}
          <div
            className="fixed inset-0 z-0 pointer-events-none opacity-30 bg-overlay-dark dark:opacity-30 light:opacity-0 transition-opacity duration-500"
            style={{
          ...
          <div className="relative z-10 flex flex-col min-h-screen w-full pt-16">
            ...
            <ChatNami />
            <footer className="w-full text-center py-6 mt-12 border-t border-slate-900 dark:border-slate-900 transition-colors">
              <p className="text-sm text-slate-500 dark:text-slate-500 font-medium">© 2026 MARKIGAI - Phùng Hải Long. All rights reserved.</p>
